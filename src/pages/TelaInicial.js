  ...
  return (
    <main className="tela-inicial">
      ...
      <section className="acao-conteiner">
        ...
        <a className="esqueceu-senha">Esqueceu a senha?</a>
      </section>
      ...
      <article className="tela-inicial__background">
        <img className="pata_1" src={PataOutline} />
        <img className="pata_2" src={PataOutline} />
        <img className="pata_3" src={PataOutline} />
        <img className="pata_4" src={PataOutline} />
      </article>
    </main>
  );
}
